...
// is used to configure middleware that parses URL-encoded data sent via HTTP requests (such as form submissions) and makes it available in the req.body object of an Express.js application.
...
app.post("/submit", (req, res) => {
  ...
  const randomAdj = Math.floor(Math.random()*(adj.length - 1) +1);
  console.log(randomAdj)

  const randomNoun = Math.floor(Math.random()*(noun.length - 1) +1);
