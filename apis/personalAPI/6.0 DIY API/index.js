...
app.get("/random", (req, res) => {
  ...
  // The method takes any JavaScript object, array, string, or other data type and converts it to JSON format automatically.
  // You don't need to manually stringify the data (unlike when using JSON.stringify()).
  // When using res.json(), Express automatically sets the Content-Type header to application/json.
...
app.get("/random/:id",(req,res)=>{
  ...
  const specificJokes = jokes.find((joke)=>joke.id===jokeId)
